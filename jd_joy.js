...
function scanMarket(type, body, cType = 'application/json') {
  return new Promise(resolve => {
    ...
    let opt = {
      ...
      url: `//draw.jdfcloud.com/common/pet/${type}?reqSource=weapp&invokeKey=`+invokeKey,
      method: "POST",
      data: body,
      credentials: "include",
...
function appScanMarket(type, body) {
  return new Promise(resolve => {
    ...
    const reqSource = 'h5';
    let opt = {
      url: `//jdjoy.jd.com/common/pet/${type}?reqSource=h5&invokeKey=`+invokeKey,
      // url: "//draw.jdfcloud.com/common/pet/getPetTaskConfig?reqSource=h5",
      method: "POST",
      data: body,
      credentials: "include",
...
function enterRoom() {
  return new Promise(resolve => {
    ...
    let opt = {
      // url: "//jdjoy.jd.com/common/pet/getPetTaskConfig?reqSource=h5",
      url: `//draw.jdfcloud.com/common/pet/enterRoom/h5?reqSource=h5&invitePin=&openId=&invokeKey=`+invokeKey,
      method: "GET",
      data: {},
      credentials: "include",
      header: {"content-type": "application/json"}
...
function appGetPetTaskConfig() {
  return new Promise(resolve => {
    ...
    const reqSource = 'h5';
    let opt = {
      url: "//jdjoy.jd.com/common/pet/getPetTaskConfig?reqSource=h5&invokeKey="+invokeKey,
